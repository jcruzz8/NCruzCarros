...
import { Fuel, Calendar, Gauge, ArrowRight, Zap, CarFront, Filter, Search, XCircle } from 'lucide-react';
...
const Stock = () => {
  ...
  // Transforma "140.000€" em 140000 para o computador conseguir ordenar
  ...
  useEffect(() => {
    ...
    if (sortOrder === 'preco-asc') {
      ...
      // Ordena por estado: Disponíveis primeiro, depois os Novos, Reservados e Vendidos no fim
      const statusOrder = { 'Novo': 1, 'Disponível': 2, 'Reservado': 3, 'Vendido': 4 };
      result.sort((a, b) => (statusOrder[a.tag] || 5) - (statusOrder[b.tag] || 5));
    } else {
      // 'recentes' (usamos o ID ou a data como base)
  ...
  // Vai buscar as marcas, anos e combustíveis ÚNICOS que existem na tua base de dados para preencher as opções
  ...
  return (
    <div className="bg-brand-dark min-h-screen pt-24 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* CABEÇALHO SÓ APARECE SE A BASE DE DADOS TIVER CARROS EM GERAL */}
        {cars.length > 0 && (
        ...
        {/* MENSAGEM SE A BASE DE DADOS ESTIVER TOTALMENTE VAZIA */}
        {cars.length === 0 ? (
          ...
          <>
            ...
            <div className="bg-neutral-900/80 backdrop-blur-md border border-white/10 p-6 rounded-2xl mb-12 shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div className="lg:col-span-2 relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-black border border-white/10 text-white p-3 pl-10 rounded-lg focus:border-brand-red outline-none transition-colors"
                  />
                </div>
              ...
              {/* Botão Limpar Filtros (Aparece se houver algum filtro ativo) */}
